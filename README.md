...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9g11r1w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9g11r1w.containers.anotherwebservice.com/
...
```
git clone git@github.com:allwhoisdata/container-9g11r1w.git
cd container-9g11r1w
```
...
```
docker attach container-9g11r1w
```
